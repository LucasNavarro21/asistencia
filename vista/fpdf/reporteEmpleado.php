...
$consulta_reporte_empleado = $conexion->query("SELECT empleado.id_empleado, empleado.nombre, empleado.apellido, empleado.dni, empleado.cargo, cargo.nombre as 'nom_cargo' from empleado inner join cargo where empleado.cargo = cargo.id_cargo");
