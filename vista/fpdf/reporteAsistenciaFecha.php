...
if(!empty($_GET["txtfechainicio"]) and !empty($_GET["txtfechafinal"]) and !empty($_GET["txtfechaempleado"])){
   require('./fpdf.php');


   $fechaInicio = $_GET['txtfechainicio'];
   $fechaFinal = $_GET['txtfechafinal'];
   $empleado = $_GET['txtfechaempleado'];
...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Cell(50, 10, utf8_decode('TOTAL HRS'), 1, 1, 'C', 1);
